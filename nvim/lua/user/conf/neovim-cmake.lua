...
cmake.setup({
  ...
  default_projects_path = tostring(Path:new(vim.loop.os_homedir(), 'hello')), -- Default folder for creating project.
  ...
  -- Command to run after starting DAP session. You can set it to `false` if you don't want 
  -- to open anything or `require('dapui').open` if you are using https://github.com/rcarriga/nvim-dap-ui
